...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "sticky  hidden md:flex flex-col bg-white dark:bg-neutral-900 shadow-md border-r border-gray-200 dark:border-neutral-800  py-6 px-3 z-50",
        className
      )}
      animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          " px-4 py-4 flex flex-row md:hidden  items-center justify-between bg-neutral-100 dark:bg-neutral-800 w-auto"
        )}
        {...props}
      >
