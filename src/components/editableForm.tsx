...
interface EditableFormProps {
    ...
    const [othersEmployeeInService, setOthersEmployeeInService] = useState<Employee[]>([]);
    ...
    const employData = async () => {
        const employeePromises = updateService.allowedEmployeeIds.map((empId) => get_employee_id(empId));
        ...
        const isAv = employeesAvailable.filter((empAv) => 
            !employeesFetched.some((emp) => emp.id === empAv.id)
        );
